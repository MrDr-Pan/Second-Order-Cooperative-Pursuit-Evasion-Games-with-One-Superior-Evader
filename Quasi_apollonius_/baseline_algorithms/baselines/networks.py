...
class AttentionCritic(nn.Module):
    def __init__(self, obs_dim, act_dim, n_agents, hidden_dim=128, hidden_dims=(128, 128), output_dim=1):
        super().__init__()
        ...
        self.out = mlp(hidden_dim * 2, hidden_dims, output_dim)
        self.apply(lambda m: init_layer(m, gain=nn.init.calculate_gain("relu")))
...
class TwinCritic(nn.Module):
    def __init__(self, input_dim, hidden_dims=(256, 256), output_dim=1):
        super().__init__()
        self.q1 = Critic(input_dim, hidden_dims, output_dim)
        self.q2 = Critic(input_dim, hidden_dims, output_dim)
